...
#
#
# text = {"list_ocr_thresh": [[1.8, 190, 255]], "text_pos": [0.46953125, 0.7902777777777777, 0.0625, 0.09861111111111111], "img_color_scale": 1, "color_range": [{"white_color": [[0, 0, 200], [255, 255, 255]]}], "color_pos": [0.46953125, 0.7902777777777777, 0.0625, 0.09861111111111111], "color_thresh": [50], "white_list": ["\d{1,2}[!-\/:-@[-`{-~ ]\d{1,2}", "\d{1,2}[^0-9]\d{1,2}"], "black_list": ["[0][!-\/:-@[-`{-~ ][0]", "[0][^0-9][0]"], "mode": "img2data_easyocr"}
#
#
# '{"list_ocr_thresh": [[1.8, 190, 255]], "text_pos": [0.46953125, 0.7902777777777777, 0.0625, 0.09861111111111111], "img_color_scale": 1, "color_range": [{"white_color": [[0, 0, 200], [255, 255, 255]]}], "color_pos": [0.46953125, 0.7902777777777777, 0.0625, 0.09861111111111111], "color_thresh": [5], "white_list": ["\\\\d{1,2}[!-\\\\/:-@[-`{-~ ]\\\\d{1,2}", "\\\\d{1,2}[^0-9]\\\\d{1,2}"], "black_list": ["[0][!-\\\\/:-@[-`{-~ ][0]", "[0][^0-9][0]"], "mode": "img2data_easyocr"}'
